...
router.post('/search', async (req, res) => {
   ...
   try {
       // Set date_from and date_to to the last full month
       const dateFrom = moment().subtract(2, 'months').startOf('month').format('YYYY-MM-DD');
       const dateTo = moment().subtract(2, 'months').endOf('month').format('YYYY-MM-DD');
